...
export const SHORTCUT_ACTIONS: readonly ShortcutAction[] = [
    ...
    { id: 'nav.previousFlagged', section: 'navigate', label: 'shortcut.navPreviousFlagged', binding: { code: 'ArrowLeft', meta: true } },
    { id: 'nav.nextFlagged', section: 'navigate', label: 'shortcut.navNextFlagged', binding: { code: 'ArrowRight', meta: true } },
