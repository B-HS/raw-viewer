...
> **[추기 2026-07-18]** 아래 수치는 OpenMP 미링크 당시 스냅샷 — 이후 build.rs가 libomp 정적 링크·X-Trans 병렬화를 적용해 갱신 실측은 [openmp-report.md](./openmp-report.md) 참조.
...
> **[추기 2026-07-18]** v0.5.3 사용자 검증에서 수동 항목 일괄 pass(docs/PROCESS.md "사용자 확인 완료" 절). 개별 체크박스는 당시 상태 그대로 보존 — 예외로 남는 항목: 휴지통 ⌘Z 복원·ProRAW Opcode(알려진 제약), ΔE00(코퍼스 미확보).
